export const studentAccounts: Record<string, string> = {
  ...
  'Abdalla Jamal': '269', 'Ismail Abdullahi': '392', 'Adan Isack': '289', 'Abdikadir Kimgol': '271',
  ...
  'Frankline Ewoi': '417', 'Mohamed Amin': '418', 'Abdishkur Mohamed': '419', 'Ramadhan Sabla': '406', 'Abdirizack Yussuf': '421', 'Abdirahman Ahmed': '422', 'Abdi Osman': '424', 'Daniel Lemoris': '425', 'Ledula Kimlahau': '426',
  'Kampicha Golicha': '427', 'Isack Munene': '428', 'Suleiman Mutethia': '429', 'Ahmed Noor': '430', 'Abdiaziz Mohamed': '431'
};
...
export const lecturers: Lecturer[] = [
  { name: 'Mr. Osman Halake', subject: 'Mathematics / Business Studies', email: 'osman@wamyisiolo.sc.ke', password: 'osman5515', isAdmin: true },
  { name: 'Mr. Abdullahi Sama', subject: 'Administration', email: 'manager@wamyisiolcenter.local', password: 'Manager123!', isAdmin: true },
  ...
  { name: 'Mr. John Simiyu', subject: 'Kiswahili / History', email: 'john@wamyisiolo.sc.ke', password: 'john373' },
  { name: 'Mrs. Selina Ewoi', subject: 'Biology / Agriculture', email: 'selina@wamyisiolo.sc.ke', password: 'selina444' },
  { name: 'Mr. Leonard Kiprotich', subject: 'Biology / Chemistry / General Science', email: 'leonard@wamyisiolo.sc.ke', password: 'leonard15' },
  { name: 'Mr. Rotich Mark', subject: 'English / Literature', email: 'rotich@wamyisiolo.sc.ke', password: 'rotich61' },
  { name: 'Mr. Kibet Shadrack', subject: 'Biology / Agriculture / Community Service Learning', email: 'kibet@wamyisiolo.sc.ke', password: 'kibet753' }
];
...
export const getComment = (marks: number): string => {
  ...
  if (marks >= 40) return 'Pull up your socks';
  if (marks >= 36) return 'You need a serious improvement';
  if (marks >= 30) return 'Below expectation';
  if (marks >= 20) return 'Poor performance';
  return 'Very poor';
};
