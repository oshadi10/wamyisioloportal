...
try {
  ...
  <img src="${logoSrc}" style="width:100px;height:100px;object-fit:contain" />
  ...
  ${studentPhotoSrc ? `<img src="${studentPhotoSrc}" style="width:90px;height:110px;object-fit:cover;border:2px solid #333;border-radius:4px;flex-shrink:0;" />` : `<div style="width:90px;height:110px;border:2px dashed #999;border-radius:4px;flex-shrink:0;"></div>`}
</div><div style="margin-top:28px;font-size:24px;line-height:1.9;font-weight:bold">
