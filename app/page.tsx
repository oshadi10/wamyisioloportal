    ...
    return (
      <main className="min-h-screen bg-gray-100">
        <Navbar
          ...
          userDetails={loggedInLecturer.role}
          onLogout={handleLogout}
        />
        <StaffPortal
 ...
 // 5. DEFAULT MAIN LAYOUT (Handles Navigation Links like About, Admissions, etc.)
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      {/* Dynamic Content Switching Based on Navbar Selection */}
      {currentPage === "Home" && (
        <>
          {/* HERO SECTION */}
            ...
            <div className="max-w-7xl mx-auto px-6 py-24 text-center">
              ...
              <div className="flex flex-col md:flex-row justify-center gap-4">
                ...
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 px-8 py-3 rounded-xl font-semibold shadow-lg transition"
                >
                  Staff Portal
                </button>
              </div>
      ...
      {currentPage === "About" && (
        <section className="max-w-4xl mx-auto px-6 py-20 min-h-[60vh]">
          <h2 className="text-4xl font-bold text-blue-900 mb-6">About Our School</h2>
          <p className="text-gray-700 text-lg leading-relaxed mb-4">
            WAMY Isiolo High School establishes an environment built upon robust academic structures and strong moral standards.
          </p>
        </section>
      )}
      ...
      {currentPage === "Admissions" && (
        <section className="max-w-4xl mx-auto px-6 py-20 min-h-[60vh]">
          <h2 className="text-4xl font-bold text-blue-900 mb-6">Admissions Procedure</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
            Details regarding enrollment requirements, deadlines, and registration fees for incoming students.
          </p>
        </section>
      )}
      ...
      {currentPage === "Contact" && (
        <section className="max-w-4xl mx-auto px-6 py-20 min-h-[60vh]">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Get in touch with the administrative desk at WAMY Centre in Isiolo for inquiries.
          </p>
        </section>
      )}
