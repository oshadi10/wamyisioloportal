      ...
      {showReminder && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 px-4">
          <div
            ...
            style={{ border: "4px solid #F59E0B", background: "#3B0764" }}
          >
            {/* Modal Header */}
            <div
            ...
            >
              <p
                ...
                style={{ color: "#3B0764" }}
              >
                WAMY Isiolo High School — Official Notice
              </p>
              <h2
                className="font-extrabold text-xl md:text-2xl uppercase tracking-wide"
                style={{ color: "#1E003C" }}
              >
                ⚠️ Important Notice to All Students
              </h2>
              <p
                className="text-xs font-semibold mt-1"
                style={{ color: "#4C1D95" }}
              >
                Reporting Back — Term 2, 2026
              </p>
            </div>
            ...
            <div className="px-6 py-5 space-y-3">
              <p
                ...
                style={{ color: "#FCD34D" }}
              >
                All students MUST comply with the following upon reporting:
              </p>
              ...
              <ul className="space-y-3 text-sm text-white">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Report back in{" "}
                    <strong style={{ color: "#FCD34D" }}>full school uniform</strong>{" "}
                    — no exceptions.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Bring personal{" "}
                    <strong style={{ color: "#FCD34D" }}>utensils</strong>{" "}
                    — cup, plate, and spoon.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Submit completed{" "}
                    <strong style={{ color: "#FCD34D" }}>mid-term assignment</strong>.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-xl leading-none flex-shrink-0">💰</span>
                  <span>
                    Pay{" "}
                    <strong style={{ color: "#FCD34D" }}>Activities Fee — Ksh 500</strong>.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-xl leading-none flex-shrink-0">🧾</span>
                  <span>
                    Ensure{" "}
                    <strong style={{ color: "#FCD34D" }}>all school fees are fully cleared</strong>{" "}
                    before reporting.
                  </span>
                </li>
              </ul>
              ...
              >
                <p className="text-white font-bold text-sm leading-6">
                  🚫 Failure to comply with <span className="underline">ANY</span> of the
                  above will result in the student being{" "}
                  <span className="underline font-extrabold">sent back home</span>.
                </p>
              </div>
            </div>
            ...
            <div className="px-6 pb-6 text-center">
              <button
                ...
                className="font-extrabold px-8 py-3 rounded-xl text-sm transition-all shadow-lg hover:scale-105 active:scale-95"
                style={{
                  background: "#F59E0B",
                  color: "#1E003C",
                }}
              >
                ✅ I Understand — Proceed to Site
              </button>
            </div>
          </div>
        </div>
